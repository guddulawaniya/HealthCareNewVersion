...
class AdapterCaregiverbyid (
    private val context : Context,
//    private val datalist: List<CaregiverItem>,
    private val datalist: ArrayList<CaregiverItem>,
    private val itemClickListener: (CaregiverItem) -> Unit
) : RecyclerView.Adapter<AdapterCaregiverbyid.ViewHolderClass>() {
