    ...
    private fun setupDietTypeSelection() {
        val options = listOf(
            Triple(
                ...
                "Vegetarian",
                R.drawable.vegitable_icon
            ),
            Triple(binding.layoutNonVeg, "Non-Veg", R.drawable.non_veg_icon),
            Triple(
                binding.layoutVegan,
                "Vegan",
                R.drawable.lucide_vegan_icon
            )
        )
        ...
        options.forEach { (layout, label, _) ->
            layout.setOnClickListener {
                ...
                options.forEach { (l, _, _) ->
                    l.setBackgroundResource(R.drawable.medical_types_bg)
                ...
                // Highlight selected
                layout.setBackgroundResource(R.drawable.medical_types_selected_bg)
        ...
        data.forEach { (name, id) ->
            val chip = Chip(requireContext()).apply {
                ...
                chipBackgroundColor = ContextCompat.getColorStateList(
                    requireContext(),
                    R.color.chip_selector_bg
                )
                setTextColor(
                    ContextCompat.getColorStateList(
                        requireContext(),
                        R.color.chip_selector_text
                    )
                )
            }
